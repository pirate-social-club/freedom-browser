...
[![Platform](https://img.shields.io/badge/platform-macOS%20|%20Linux%20|%20Windows-lightgrey)](https://github.com/pirate/freedom-browser/releases)
...
- Linux and Windows jobs run on GitHub-hosted runners; macOS builds remain on GitHub-hosted macOS runners because the release pipeline still needs an `x64` macOS build
